...
bool MultiROM::installFromBackup(std::string name, std::string path, int type)
{
...
#else
	struct PartitionSettings sys_part_settings;
	struct PartitionSettings data_part_settings;
	...
	if(sys_part_settings.Part && data_part_settings.Part)
	{
		...
		sys_part_settings.Backup_Folder = path;
		sys_part_settings.partition_count = partCnt;
		sys_part_settings.total_restore_size = total_restore_size;

		data_part_settings.Backup_Folder = path;
		data_part_settings.partition_count = partCnt;
		data_part_settings.total_restore_size = total_restore_size;
